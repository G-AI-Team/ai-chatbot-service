    ...
    >
      {
        Array.from({ length: 16 }).map((_, index) => (
          <div
            key={index}
            className={cn(
              'mb-3 mr-3 h-[144px] w-[calc((100%-36px)/4)] rounded-md bg-background-section-burn',
              index % 4 === 3 && 'mr-0',
              index > 11 && 'mb-0',
      ...
      <div className="absolute left-1/2 top-1/2 z-[2] flex -translate-x-1/2 -translate-y-1/2 flex-col items-center">
        <div className="relative mb-3 flex h-14 w-14 items-center justify-center rounded-md border border-dashed border-divider-deep bg-components-card-bg shadow-lg">
