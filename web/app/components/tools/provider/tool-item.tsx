...
const ToolItem = ({
  ...
  return (
    <>
      <div
        className={cn('bg-components-panel-item-bg cursor-pointer rounded-md border-[0.5px] border-components-panel-border-subtle px-4 py-3 shadow-xs hover:bg-components-panel-on-panel-item-bg-hover', disabled && '!cursor-not-allowed opacity-50')}
