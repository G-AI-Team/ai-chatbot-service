...
export const NodeSourceHandle = memo(({
  ...
  return (
    <Handle
      ...
      onClick={handleHandleClick}
    >
      <div className="absolute -top-1 left-1/2 hidden -translate-x-1/2 -translate-y-full rounded-md border-[0.5px] border-components-panel-border bg-components-tooltip-bg p-1.5 shadow-lg group-hover/handle:block">
