...
const InputNumberWithSlider: FC<InputNumberWithSliderProps> = ({
  ...
  return (
    <div className="flex h-8 items-center justify-between space-x-2">
      <input
        value={value}
        className="block h-8 w-12 shrink-0 appearance-none rounded-md bg-components-input-bg-normal pl-3 text-[13px] text-components-input-text-filled outline-none"
        type="number"
        min={min}
        max={max}
        step={1}
