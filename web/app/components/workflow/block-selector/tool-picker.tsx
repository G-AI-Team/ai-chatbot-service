  ...
  return (
    ...
    >
      ...
      <PortalToFollowElemContent className="z-[1000]">
        <div className={cn('relative min-h-20 rounded-md border-[0.5px] border-components-panel-border bg-components-panel-bg-blur shadow-lg backdrop-blur-sm', panelClassName)}>
