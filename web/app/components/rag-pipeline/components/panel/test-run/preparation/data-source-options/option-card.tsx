...
const OptionCard = ({
  ...
  return (
    <div
      className={cn(
        'flex cursor-pointer flex-col gap-1 rounded-md border border-components-option-card-option-border bg-components-option-card-option-bg p-2.5 shadow-shadow-shadow-3',
        selected
    ...
    >
      <div className="flex size-7 shrink-0 items-center justify-center rounded-md border-[0.5px] border-components-panel-border bg-background-default-dodge p-1">
        <BlockIcon
