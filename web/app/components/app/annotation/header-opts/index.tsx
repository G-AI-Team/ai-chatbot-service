  ...
  const Operations = () => {
    return (
      <div className="w-full py-1">
        <button
          type="button"
          className="mx-1 flex h-9 w-[calc(100%_-_8px)] cursor-pointer items-center space-x-2 rounded-md px-3 py-2 hover:bg-components-panel-on-panel-item-bg-hover disabled:opacity-50"
          onClick={() => {
        ...
        <Menu as="div" className="relative h-full w-full">
          <MenuButton className="mx-1 flex h-9 w-[calc(100%_-_8px)] cursor-pointer items-center space-x-2 rounded-md px-3 py-2 hover:bg-components-panel-on-panel-item-bg-hover disabled:opacity-50">
          ...
          >
            <MenuItems
              className={cn(
                'absolute left-1 top-[1px] z-10 min-w-[100px] origin-top-right -translate-x-full rounded-md border-[0.5px] border-components-panel-on-panel-item-bg bg-components-panel-bg py-1 shadow-xs',
              )}
            >
              <CSVDownloader
                type={Type.Link}
              ...
              >
                <button type="button" disabled={annotationUnavailable} className="mx-1 flex h-9 w-[calc(100%_-_8px)] cursor-pointer items-center space-x-2 rounded-md px-3 py-2 hover:bg-components-panel-on-panel-item-bg-hover disabled:opacity-50">
                  <span className="system-sm-regular grow text-left text-text-secondary">CSV</span>
                </button>
              </CSVDownloader>
              <button type="button" disabled={annotationUnavailable} className={cn('mx-1 flex h-9 w-[calc(100%_-_8px)] cursor-pointer items-center space-x-2 rounded-md px-3 py-2 hover:bg-components-panel-on-panel-item-bg-hover disabled:opacity-50', '!border-0')} onClick={JSONLOutput}>
        ...
        <button
          ...
          className="mx-1 flex h-9 w-[calc(100%_-_8px)] cursor-pointer items-center space-x-2 rounded-md px-3 py-2 text-red-600 hover:bg-red-50 disabled:opacity-50"
        >
