    ...
    >
      ...
      {option === 'chromePlugin' && (
        <div className="mt-6 w-full">
          <div className={cn('inline-flex w-full items-center justify-center gap-2 rounded-md py-3', 'shrink-0 cursor-pointer bg-primary-600 text-white hover:bg-primary-600/75 hover:shadow-sm')}>
      ...
      <div className={cn('inline-flex w-full flex-col items-start justify-start rounded-md border-[0.5px] border-components-panel-border bg-background-section', 'mt-6')}>
