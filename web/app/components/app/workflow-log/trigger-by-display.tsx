...
const getTriggerIcon = (triggeredFrom: WorkflowRunTriggeredFrom, metadata: TriggerMetadata | undefined, theme: Theme) => {
  switch (triggeredFrom) {
    case 'webhook':
      return (
        <div className="rounded-md border-[0.5px] border-divider-subtle bg-util-colors-blue-blue-500 p-1 shadow-md">
          <WebhookLine className="h-4 w-4 text-text-primary-on-surface" />
        </div>
      )
    case 'schedule':
      return (
        <div className="rounded-md border-[0.5px] border-divider-subtle bg-util-colors-violet-violet-500 p-1 shadow-md">
    ...
    case 'rag-pipeline-debugging':
      return (
        <div className="rounded-md border-[0.5px] border-divider-subtle bg-util-colors-green-green-500 p-1 shadow-md">
    ...
    default:
      ...
      return (
        <div className="rounded-md border-[0.5px] border-divider-subtle bg-util-colors-blue-brand-blue-brand-500 p-1 shadow-md">
