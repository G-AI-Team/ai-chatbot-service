  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger onClick={togglePopup}>
        <div className={cn('ml-1 flex cursor-pointer select-none items-center rounded-md px-2 py-0.5 hover:bg-state-base-hover', open && 'bg-state-base-hover')}>
      ...
      <PortalToFollowElemContent className="z-[11]">
        <div className="w-[360px] rounded-md border-[0.5px] border-components-panel-border bg-components-panel-bg-blur p-1 pt-2 shadow-lg backdrop-blur-[5px]">
