...
const FileList = ({
  ...
  return (
    <div className="flex h-[400px] flex-col overflow-hidden rounded-md border border-components-panel-border bg-components-panel-bg shadow-xs shadow-shadow-shadow-3">
      <Header
