...
const OptionCard = ({
  ...
  return (
    <div
      className={cn(
        'flex cursor-pointer items-center gap-2 rounded-md border border-components-option-card-option-border bg-components-option-card-option-bg p-3 shadow-shadow-shadow-3',
        selected
      ...
      onClick={onClick}
    >
      <div className="flex size-8 shrink-0 items-center justify-center rounded-md border-[0.5px] border-components-panel-border bg-background-default-dodge p-1.5">
