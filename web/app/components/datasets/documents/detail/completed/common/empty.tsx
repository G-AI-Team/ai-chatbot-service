...
const EmptyCard = React.memo(() => {
  return (
    <div className="h-32 w-full shrink-0 rounded-md bg-background-section-burn opacity-30" />
  )
})
  ...
  return (
    <div className="relative z-0 flex h-full items-center justify-center">
      <div className="flex flex-col items-center">
        <div className="relative z-10 flex h-14 w-14 items-center justify-center rounded-md border border-divider-subtle bg-components-card-bg shadow-lg shadow-shadow-shadow-5">
