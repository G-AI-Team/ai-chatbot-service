...
const UpgradeCard: FC = () => {
  ...
  return (
    <div className="flex items-center justify-between rounded-md border-[0.5px] border-components-panel-border-subtle bg-components-panel-on-panel-item-bg py-3 pl-4 pr-3.5 shadow-xs backdrop-blur-[5px] ">
      <div>
      ...
      <UpgradeBtn
        size="custom"
        isShort
        className="ml-3 !h-8 !rounded-md px-2"
