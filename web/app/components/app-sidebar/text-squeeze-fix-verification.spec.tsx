  ...
  return (
    <div className="nav-link-container">
      ...
      >
        ...
        <span
          className={`whitespace-nowrap transition-all duration-200 ease-in-out ${mode === 'expand'
              ? 'w-auto opacity-100'
  ...
  return (
    <div className="app-info-container">
      <div className={`flex rounded-md ${expand ? 'flex-col gap-2 p-2 pb-2.5' : 'items-start justify-center gap-1 p-1'}`}>
        ...
        <div
          className={`flex flex-col items-start gap-1 transition-all duration-200 ease-in-out ${expand
              ? 'w-auto opacity-100'
              : 'pointer-events-none w-0 overflow-hidden opacity-0'
            }`}
