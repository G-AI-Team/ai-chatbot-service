  ...
  if (disabled) {
    return (
      <button
        ...
        type="button"
        disabled
        className={cn('system-sm-medium flex h-8 cursor-not-allowed items-center rounded-md text-components-menu-item-text opacity-30 hover:bg-components-menu-item-bg-hover', 'pl-3 pr-1')}
  ...
  return (
    <Link
      ...
      className={cn(isActive
        ...
        : 'system-sm-medium text-components-menu-item-text hover:bg-components-menu-item-bg-hover hover:text-components-menu-item-text-hover', 'flex h-8 items-center rounded-md pl-3 pr-1')}
      title={mode === 'collapse' ? name : ''}
    >
      {renderIcon()}
      <span
