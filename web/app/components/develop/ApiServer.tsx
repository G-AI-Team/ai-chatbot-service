...
const ApiServer: FC<ApiServerProps> = ({
  ...
  return (
    <div className="flex flex-wrap items-center gap-y-2">
      <div className="mr-2 flex h-8 items-center rounded-md border-[0.5px] border-components-input-border-active bg-components-input-bg-normal pl-1.5 pr-1 leading-5">
      ...
      <div className="mr-2 flex h-8 items-center rounded-md border-[0.5px] border-[#D1FADF] bg-[#ECFDF3] px-3 text-xs font-semibold text-[#039855]">
        {t('ok', { ns: 'appApi' })}
      </div>
      <SecretKeyButton
