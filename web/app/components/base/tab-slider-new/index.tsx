    ...
    <div className={cn(className, 'relative flex')}>
      {options.map(option => (
        <div
          ...
          className={cn(
            'mr-1 flex h-[32px] cursor-pointer items-center rounded-md border-[0.5px] border-transparent px-3 py-[7px] text-[13px] font-medium leading-[18px] text-text-tertiary hover:bg-state-base-hover',
