  ...
  return (
    ...
    >
      ...
      <PortalToFollowElemContent className="z-50">
        ...
        >
          <div className={cn('system-md-regular flex cursor-pointer items-center space-x-1 rounded-md px-2 py-1.5 text-text-secondary hover:bg-state-base-hover')} onClick={togglePin}>
          ...
          {isShowRenameConversation && (
            <div className={cn('system-md-regular flex cursor-pointer items-center space-x-1 rounded-md px-2 py-1.5 text-text-secondary hover:bg-state-base-hover')} onClick={onRenameConversation}>
              <RiEditLine className="h-4 w-4 shrink-0 text-text-tertiary" />
              <span className="grow">{t('sidebar.action.rename', { ns: 'explore' })}</span>
            </div>
          )}
          {isShowDelete && (
            <div className={cn('system-md-regular group flex cursor-pointer items-center space-x-1 rounded-md px-2 py-1.5 text-text-secondary hover:bg-state-destructive-hover hover:text-text-destructive')} onClick={onDelete}>
