...
const CustomPage = () => {
  ...
  return (
    <div className="flex flex-col">
      {showBillingTip && (
        <div className="mb-1 flex justify-between rounded-md bg-gradient-to-r from-components-input-border-active-prompt-1 to-components-input-border-active-prompt-2 p-4 pl-6 shadow-lg backdrop-blur-sm">
