  ...
  return (
    <>
      {Array.from({ length: count }).map((_, index) => (
        <div
          key={index}
          className="h-[160px] rounded-md border-[0.5px] border-components-card-border bg-components-card-bg p-4"
        >
          <SkeletonContainer className="h-full">
            <SkeletonRow>
              <SkeletonRectangle className="h-10 w-10 animate-pulse rounded-md" />
